...
class Ui_ProjetosFinalizados(object):
    def setupUi(self, MainWindow):
        ...
        self.Projetos_Finalizados = QListWidget(self.frame_6)
        self.Projetos_Finalizados.setObjectName(u"Projetos_Finalizados")
        self.Projetos_Finalizados.setStyleSheet(u"border: 1px solid #D2D2D2;\n"
                                                "border-radius: 10px;\n"
                                                "background: #FEF8E8;")
        self.Projetos_Finalizados.setSpacing(10)
        self.horizontalLayout_4.addWidget(self.Projetos_Finalizados)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"Projetos Finalizados", None))
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"Projetos Finalizados", None))
